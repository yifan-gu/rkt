...
func newV1alphaReadOnlyAPIServer(store *imagestore.Store) (*v1alphaReadOnlyAPIServer, error) {
	...
	return &v1alphaReadOnlyAPIServer{
		store:    store,
		podCache: podCache,
		imgCache: imgCache,
	}, nil
...
func (s *v1alphaReadOnlyAPIServer) getPodManifest(p *pod) (*schema.PodManifest, []byte, error) {
...
func (s *v1alphaReadOnlyAPIServer) getBasicPodFromDisk(p *pod) (*v1alpha.Pod, error) {
...
func (s *v1alphaReadOnlyAPIServer) getBasicPod(p *pod) *v1alpha.Pod {
...
func (s *v1alphaReadOnlyAPIServer) getImageInfo(imageID string) (*v1alpha.Image, error) {
...
func (s *v1alphaReadOnlyAPIServer) getImageInfoFromDisk(store *imagestore.Store, imageID string) (*v1alpha.Image, error) {
...
func (s *v1alphaReadOnlyAPIServer) ListenEvents(request *v1alpha.ListenEventsRequest, stream v1alpha.PublicAPI_ListenEventsServer) error {
