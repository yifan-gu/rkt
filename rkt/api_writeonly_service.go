...
func (s *v1alphaWriteOnlyAPIServer) PreparePod(ctx context.Context, request *v1alpha.PreparePodRequest) (*v1alpha.PreparePodResponse, error) {
	return nil, fmt.Errorf("not implemented")
}

func (s *v1alphaWriteOnlyAPIServer) RemovePod(ctx context.Context, request *v1alpha.RemovePodRequest) (*v1alpha.RemovePodResponse, error) {
	return nil, fmt.Errorf("not implemented")
}
...
func (s *v1alphaWriteOnlyAPIServer) EnterPod(stream v1alpha.PublicWriteOnlyAPI_EnterPodServer) error {
