...
type Pod struct {
	...
	// Timestamp of when the pod is finished, nanoseconds since epoch.
	// Note that there will be a time window between this and the
	// actual pod finish time, because this time is when the pod
	// is moved to exited-garbage or garbage dirs.
	// Zero if the pod is not finished.
	FinishedAt int64 `protobuf:"varint,11,opt,name=finished_at" json:"finished_at,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
